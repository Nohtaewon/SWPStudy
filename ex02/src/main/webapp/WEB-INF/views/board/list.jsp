			...
			<div class="pull-right cleatfix">
				<ul class="pagination">
						...
						<li>
							<c:choose>
								<c:when test="${pageMaker.cri.pageNum eq num }">
									<a  class="active" href='/board/list?pageNum=${num }&amount=${pageMaker.cri.amount }'>
										${num }
									</a>
								</c:when>
								<c:otherwise>
					...
					<c:if test="${pageMaker.next }">
						<li class="paginate_button next"><a href="/board/list?pageNum=${pageMaker.endPage+1 }">Next</a></li>
					</c:if>
				</ul>
